...
class ClienteBancario:
    ...
    #============================================
    # Mentodo privado con dos guiones bajos
    ...
    def guardarDinero(self, cantidad:float)->None:
        ...
        self.__mandarEmail("----guardando deposito----", " se recivieron"+ str(cantidad))
    ...
    def retirarDinero(self, cantidad:float)-> None:
        ...
        self.__mandarEmail("----retirando----", " se retiro "+ str(cantidad))
        self.__enviarBalanceAlBanco(cantidad)
